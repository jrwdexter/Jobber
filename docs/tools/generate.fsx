...
let githubLink = "http://github.com/mandest@gmail.com/Jobber"

// Specify more information about your project
let info =
  [ "project-name", "Jobber"
    "project-author", "Jonathan Dexter"
    "project-summary", "A library for processing jobs, which allows a succinct system for combining complex pipelines and tasks into a centrally managed framework."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Jobber" ]
